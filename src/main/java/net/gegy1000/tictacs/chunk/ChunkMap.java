...
public final class ChunkMap {
    ...
    private ChunkEntry createEntry(long pos, int level) {
        ChunkManager tacs = this.controller.asTacs();
        ...
        return new ChunkEntry(new ChunkPos(pos), level, this.world.getLightManager(), accessor.getChunkTaskPrioritySystem(), tacs);
    }
